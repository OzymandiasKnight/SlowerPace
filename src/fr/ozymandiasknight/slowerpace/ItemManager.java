...
public class ItemManager {
	...
	public void setup() {
		...
		ArrayList<String> vign_conditions = new ArrayList<String>(Arrays.asList("miner:3","farmer:4"));
		...
		ArrayList<String> katana_conditions = new ArrayList<String>(Arrays.asList("miner:3","hunter:5"));
		...
		ArrayList<String> wind_conditions = new ArrayList<String>(Arrays.asList("hunter:2","level:7"));
		...
		ArrayList<String> grappling_conditions = new ArrayList<String>(Arrays.asList("farmer:6", "level:10"));
